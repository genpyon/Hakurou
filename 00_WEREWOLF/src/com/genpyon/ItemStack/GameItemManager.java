...
public class GameItemManager {
	...
	public static final String PLAYERS_HEAD_INV_NAME = ChatColor.DARK_GREEN + "" + ChatColor.BOLD + "プレイヤーリスト";

	static public ItemStack PLAYERS_HEAD() {
		ItemStack is = lib.createItem(Material.OBSERVER, 1, PLAYERS_HEAD_INV_NAME, "" ,ChatColor.RESET + "プレイヤーの顔、ID、宣言情報を",ChatColor.RESET + "見ることができる。","",ChatColor.RESET +"探偵を宣言している場合、",ChatColor.RESET +"このアイテムを使用すると",ChatColor.RESET +"占い結果を宣言することができる");
		return is;
	}

	public static final String DETECTI_URANAI_INV_NAME = ChatColor.BLUE + "" + ChatColor.BOLD + "占いの結果を全体に知らせる";



	static public String CO_INNOCENT_HEAD = ChatColor.GREEN + "村人の帽子";
	...
	static public String CO_MAGO_HEAD = ChatColor.GREEN + "孫の帽子";
	...
	static public String CO_TYOUROU_HEAD = ChatColor.DARK_GREEN + "長老の帽子";
	...
	static public String CO_DETECTIVE_HEAD = ChatColor.BLUE + "探偵の帽子";
	...
	static public String CO_WEREWOLF_HEAD = ChatColor.RED + "人狼の帽子";
	...
	static public String CO_HAKUROU_HEAD = ChatColor.DARK_RED + "白狼の帽子";
	...
	static public String CO_JACKAL_HEAD = ChatColor.AQUA + "妖狐の帽子";
	...
	static public String CO_GRAY_HEAD = ChatColor.GRAY + "グレーの帽子";
