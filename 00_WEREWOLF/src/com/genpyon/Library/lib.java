...
public class lib {
	...
	public static ItemStack createItem(Material material,int am, String name, String... list){
	...
	static public void setSkin(String st, Player a){
        ItemStack skull = new ItemStack(Material.SKULL_ITEM, 1, (short) SkullType.PLAYER.ordinal());

        SkullMeta meta = (SkullMeta) skull.getItemMeta();
        meta.setOwner(st);
        //meta.setDisplayName(st+ "の頭");
        skull.setItemMeta(meta);

        a.getInventory().addItem(skull);
	}
	...
	public static void sendTitleTarget(Player target, String main, String sub) {
			IChatBaseComponent text = new ChatMessage(main);
			PacketPlayOutTitle title = new PacketPlayOutTitle(EnumTitleAction.TITLE, text);
